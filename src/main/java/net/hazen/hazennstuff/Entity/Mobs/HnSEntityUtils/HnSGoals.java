...
//
//        public FlyingWizardAttackGoal(AbstractSpellCastingMob abstractSpellCastingMob, double speedModifier, int attackInterval) {
//            this(abstractSpellCastingMob, speedModifier, attackInterval, attackInterval);
//        }
//
//        public FlyingWizardAttackGoal(AbstractSpellCastingMob abstractSpellCastingMob, double speedModifier, int attackIntervalMin, int attackIntervalMax) {
...
//            if (var2 instanceof AbstractSpellCastingMob pet) {
//                if (pet.isImmobile()) {
//                    return false;
//                }
//            }

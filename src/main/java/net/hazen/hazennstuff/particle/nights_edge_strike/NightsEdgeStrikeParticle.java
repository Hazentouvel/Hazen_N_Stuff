...
public class NightsEdgeStrikeParticle extends TextureSheetParticle {
    private final SpriteSet sprites;
    private final Vec3 forward;
    private final boolean mirror, vertical;
    private final Vector3f[] localVertices;

    NightsEdgeStrikeParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double xd, double yd, double zd, NightsEdgeStrikeParticleOptions options) {
    ...
    private void createBloodTrail() {
        ...
        for (int i = 1; i < particleCount - 1; i++) {
            ...
            level.addParticle(ParticleHelper.BLOOD, x + localPos.x, y + localPos.y, z + localPos.z, 0, 0, 0);
        }
    }
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<NightsEdgeStrikeParticleOptions> {
        ...
        public Particle createParticle(@NotNull NightsEdgeStrikeParticleOptions options, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            NightsEdgeStrikeParticle shriekparticle = new NightsEdgeStrikeParticle(pLevel, pX, pY, pZ, sprite, pXSpeed, pYSpeed, pZSpeed, options);

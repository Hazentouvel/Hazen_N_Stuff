...
public class FireblossomBattlemageArmorRenderer extends GeoArmorRenderer<FireblossomBattlemageArmorItem> {
    public FireblossomBattlemageArmorRenderer(FireblossomBattlemageArmorModel fireblossomBattlemageArmorModel) {
        super(new FireblossomBattlemageArmorModel());
        this.addRenderLayer(new FireblossomBattlemageArmorLayer(this));
    ...
    public RenderType getRenderType(FireblossomBattlemageArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

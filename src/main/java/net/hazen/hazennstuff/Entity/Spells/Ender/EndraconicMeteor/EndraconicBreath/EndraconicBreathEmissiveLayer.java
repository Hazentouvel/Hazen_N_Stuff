...
public class EndraconicBreathEmissiveLayer extends GeoRenderLayer<EndraconicBreath> {

    public EndraconicBreathEmissiveLayer(GeoEntityRenderer<EndraconicBreath> renderer) {
        super(renderer);
    }
    ...
    public void render(
        ...
        ResourceLocation frameTexture = ResourceLocation.fromNamespaceAndPath(
                "hazennstuff",
                "textures/spells/endraconic_breath_" + frame + ".png"
        );

...
public class SpadeRenderer extends GeoEntityRenderer<Spade> {
    public SpadeRenderer(EntityRendererProvider.Context context) {
        super(context, new SpadeModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, Spade animatable, BakedGeoModel model,

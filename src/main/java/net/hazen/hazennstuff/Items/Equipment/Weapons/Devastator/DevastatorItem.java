...
public class DevastatorItem extends HnSGeoMagicSwordItem implements UniqueItem {

    public DevastatorItem(SpellDataRegistryHolder[] spellDataRegistryHolders) {
        super(HnSExtendedWeaponTiers.DEVESTATOR,
                HnSExtendedWeaponTiers.DEVESTATOR.getAttackDamageBonus(),
                HnSExtendedWeaponTiers.DEVESTATOR.getSpeed(),
                spellDataRegistryHolders,
                Map.of(
                        AttributeRegistry.BLOOD_SPELL_POWER.get(), new AttributeModifier(UUID.fromString("a552273e-6669-4cd2-80b3-a703b7616336"),
                                "Blood Spell Power", 0.1f, AttributeModifier.Operation.MULTIPLY_TOTAL),
    ...
    public BlockEntityWithoutLevelRenderer getRenderer() {
        return new DevastatorRenderer(new DevastatorModel());
    }
}
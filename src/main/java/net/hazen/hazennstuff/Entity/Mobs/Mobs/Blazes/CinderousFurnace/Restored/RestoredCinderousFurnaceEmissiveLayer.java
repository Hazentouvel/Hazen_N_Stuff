...
public class RestoredCinderousFurnaceEmissiveLayer extends GeoRenderLayer<AbstractSpellCastingMob> {

    public RestoredCinderousFurnaceEmissiveLayer(GeoEntityRenderer<AbstractSpellCastingMob> renderer) {
        super(renderer);
    }
    ...
    public void render(
        ...
        ResourceLocation frameTexture = ResourceLocation.fromNamespaceAndPath(
                HazenNStuff.MOD_ID,
                "textures/mobs/cinderous_furnace_blaze_restored.png"
        );

...
public class AegisRenderer extends AbstractSpellCastingMobRenderer {
    public AegisRenderer(EntityRendererProvider.Context context) {
        super(context, new AegisModel());

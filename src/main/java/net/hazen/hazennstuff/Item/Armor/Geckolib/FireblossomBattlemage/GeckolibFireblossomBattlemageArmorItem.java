...
public class GeckolibFireblossomBattlemageArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    public GeckolibFireblossomBattlemageArmorItem(Type type, Properties settings) {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof GeckolibFireblossomBattlemageArmorItem &&

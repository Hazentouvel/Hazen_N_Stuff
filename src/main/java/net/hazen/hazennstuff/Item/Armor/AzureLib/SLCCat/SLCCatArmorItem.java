...
public class SLCCatArmorItem extends ImbuableHnSArmorItem implements IDisableJacket, IDisableHat {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof SLCCatArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof SLCCatArmorItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof SLCCatArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof SLCCatArmorItem;
    }
}
...
public class RazorbladeTyphoonRenderer extends GeoEntityRenderer<RazorbladeTyphoon> {
    public RazorbladeTyphoonRenderer(EntityRendererProvider.Context context) {
        super(context, new RazorbladeTyphoonModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, RazorbladeTyphoon animatable, BakedGeoModel model,

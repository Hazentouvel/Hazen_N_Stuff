...
public class EnderDragonArmorRenderer extends GeoArmorRenderer<EnderDragonArmorItem> {
    public EnderDragonArmorRenderer(EnderDragonArmorModel enderDragonArmorModel) {
        super(new EnderDragonArmorModel());
        this.addRenderLayer(new EnderDragonArmorLayer(this));
    ...
    public RenderType getRenderType(EnderDragonArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

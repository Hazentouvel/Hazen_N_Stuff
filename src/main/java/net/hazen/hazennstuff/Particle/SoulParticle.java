...
public class SoulParticle extends TextureSheetParticle {
    ...
    public SoulParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public void tick() {
        ...
        if (!this.removed) {
            ...
            if (this.random.nextFloat() > f) {
                this.level.addParticle((ParticleOptions) ASParticleRegistry.TRAIL, this.x, this.y, this.z, this.xd, this.yd, this.zd);
            }
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>
    {
        ...
        public @Nullable Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz) {
            return new SoulParticle(clientLevel, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
...
public class FireblossomBattlemageCrownArmorRenderer extends GeoArmorRenderer<FireblossomBattlemageCrownArmorItem> {
    public FireblossomBattlemageCrownArmorRenderer(FireblossomBattlemageCrownArmorModel fireblossomBattlemageCrownArmorModel) {
        super(new FireblossomBattlemageCrownArmorModel());
        this.addRenderLayer(new FireblossomBattlemageCrownArmorLayer(this));
    ...
    public RenderType getRenderType(FireblossomBattlemageCrownArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

...
public class WaterBoltRenderer extends GeoEntityRenderer<WaterBolt> {
    public WaterBoltRenderer(EntityRendererProvider.Context context) {
        super(context, new WaterBoltModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, WaterBolt animatable, BakedGeoModel model,

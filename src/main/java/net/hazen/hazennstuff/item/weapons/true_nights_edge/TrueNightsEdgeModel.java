...
public class TrueNightsEdgeModel extends DefaultedItemGeoModel<TrueNightsEdgeItem> {
    ...
    public ResourceLocation getModelResource(TrueNightsEdgeItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "geo/true_nights_edge.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(TrueNightsEdgeItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "textures/item/weapons/true_nights_edge/true_nights_edge.png");
    }

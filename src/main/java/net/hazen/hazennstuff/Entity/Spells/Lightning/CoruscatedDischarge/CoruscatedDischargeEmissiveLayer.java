...
public class CoruscatedDischargeEmissiveLayer extends GeoRenderLayer<CoruscatedDischarge> {

    public CoruscatedDischargeEmissiveLayer(GeoEntityRenderer<CoruscatedDischarge> renderer) {
        super(renderer);
    }
    ...
    public void render(
            PoseStack poseStack,
            CoruscatedDischarge animatable,
        ...
        ResourceLocation frameTexture = ResourceLocation.fromNamespaceAndPath(
                "hazennstuff",
                "textures/spells/coruscated_discharge_" + frame + ".png"
        );

...
public class GeckolibAstraconicWeaverArmorModel extends DefaultedEntityGeoModel<GeckolibAstraconicWeaverArmorItem> {
    public GeckolibAstraconicWeaverArmorModel() {
    ...
    @Override
    public ResourceLocation getAnimationResource(GeckolibAstraconicWeaverArmorItem animatable) {

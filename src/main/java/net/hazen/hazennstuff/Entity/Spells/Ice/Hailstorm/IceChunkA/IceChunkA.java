...
public class IceChunkA extends AbstractMagicProjectile implements GeoEntity {
    public IceChunkA(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public IceChunkA(Level pLevel, LivingEntity pShooter) {
        this(HnSEntityRegistry.ICE_CHUNK_A.get(), pLevel);
    ...
    private final RawAnimation idle = RawAnimation.begin().thenLoop("animation.ice_chunk.spinning_b");

...
import net.hazen.hazennstuff.item.armor.AzureLib.LemonGod.LemonGodAnimator;
...
public class AscendedLemonGodArmorRenderer extends AzArmorRenderer {
    ...
    public AscendedLemonGodArmorRenderer() {
        super(
                AzArmorRendererConfig.builder(GEO, TEX)
                        .setAnimatorProvider(AscendedLemonGodAnimator::new)

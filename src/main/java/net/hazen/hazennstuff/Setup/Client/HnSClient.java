package net.hazen.hazennstuff.Setup.Client;
...
public class HnSClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        HazenNStuff.LOGGER.info("HELLO FROM CLIENT SETUP");
        HazenNStuff.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}

...
public class HeartRenderer extends GeoEntityRenderer<Heart> {
    public HeartRenderer(EntityRendererProvider.Context context) {
        super(context, new HeartModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, Heart animatable, BakedGeoModel model,

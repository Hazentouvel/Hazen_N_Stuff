...
public class FleshMoundRenderer extends GeoEntityRenderer<FleshMound> {
    ...
    @Override
    public void preRender(PoseStack poseStack, FleshMound animatable, BakedGeoModel model,
    ...
    @Override
    public RenderType getRenderType(FleshMound animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {

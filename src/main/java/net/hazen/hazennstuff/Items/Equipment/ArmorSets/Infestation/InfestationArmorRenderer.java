...
public class InfestationArmorRenderer extends GeoArmorRenderer<InfestationArmorItem> {
    public InfestationArmorRenderer(InfestationArmorModel infestationArmorModel) {
        super(new InfestationArmorModel());
        this.addRenderLayer(new InfestationArmorLayer(this));
    ...
    public RenderType getRenderType(InfestationArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

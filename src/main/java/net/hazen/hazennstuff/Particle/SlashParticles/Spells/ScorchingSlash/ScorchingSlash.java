...
public class ScorchingSlash extends TextureSheetParticle {
    ...
    ScorchingSlash(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double xd, double yd, double zd, ScorchingSlashOptions options) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<ScorchingSlashOptions> {
        ...
        public Particle createParticle(@NotNull ScorchingSlashOptions options, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            ScorchingSlash shriekparticle = new ScorchingSlash(pLevel, pX, pY, pZ, this.sprite, pXSpeed, pYSpeed, pZSpeed, options);

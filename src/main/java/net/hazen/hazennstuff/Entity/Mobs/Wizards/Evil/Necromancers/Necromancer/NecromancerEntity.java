...
public class NecromancerEntity extends AbstractSpellCastingMob implements Enemy {
    ...
    protected void populateDefaultEquipmentSlots(RandomSource pRandom, DifficultyInstance pDifficulty) {
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(HnSItems.NECROMANCER_HELMET.get()));
        this.setDropChance(EquipmentSlot.HEAD, 0.0f);
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(HnSItems.NECROMANCER_CHESTPLATE.get()));
        this.setDropChance(EquipmentSlot.CHEST, 0.0F);
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(HnSItems.NECROMANCER_LEGGINGS.get()));

...
import net.hazen.hazennstuff.item.armor.Geckolib.CrystalArachnid.CrystalArachnidArmorModel;
...
public class HertaPuppetArmorItem extends ImbuableGeckolibHnSArmorItem {

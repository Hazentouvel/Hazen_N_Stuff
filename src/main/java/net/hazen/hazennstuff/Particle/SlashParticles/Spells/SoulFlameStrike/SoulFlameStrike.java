...
public class SoulFlameStrike extends TextureSheetParticle {
    ...
    SoulFlameStrike(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double xd, double yd, double zd, SoulFlameStrikeOptions options) {
    ...
    private void createBladeParticle() {
        ...
        for(int i = 1; i < particleCount - 1; ++i) {
            ...
            this.level.addParticle(ParticleHelper.SOUL_FIRE, this.x + localPos.x, this.y + localPos.y, this.z + localPos.z, (double)0.0F, (double)0.0F, (double)0.0F);
        }
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<SoulFlameStrikeOptions> {
        ...
        public Particle createParticle(@NotNull SoulFlameStrikeOptions options, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            SoulFlameStrike shriekparticle = new SoulFlameStrike(pLevel, pX, pY, pZ, this.sprite, pXSpeed, pYSpeed, pZSpeed, options);

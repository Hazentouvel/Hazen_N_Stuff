...
public class SeraphArmorRenderer extends GeoArmorRenderer<SeraphArmorItem> {
    public SeraphArmorRenderer(SeraphArmorModel seraphArmorModel) {
        super(new SeraphArmorModel());
        this.addRenderLayer(new SeraphArmorLayer(this));
    ...
    public RenderType getRenderType(SeraphArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

package net.hazen.hazennstuff.Items.Equipment.ArmorSets.Blazeborne;
...
public class BlazeborneArmorRenderer extends GeoArmorRenderer<BlazeborneArmorItem> {
    public BlazeborneArmorRenderer(BlazeborneArmorModel blazeborneArmorModel) {
        super(new BlazeborneArmorModel());
        this.addRenderLayer(new BlazeborneArmorLayer(this));
    ...
    public RenderType getRenderType(BlazeborneArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

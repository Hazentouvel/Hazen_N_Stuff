package net.hazen.hazennstuff.item.armor.Geckolib.Miner;
...
public class MinerArmorModel extends DefaultedEntityGeoModel<MinerArmorItem> {
    ...
    public ResourceLocation getModelResource(MinerArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "geo/armor/miner_armor_geckolib.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MinerArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "textures/armor/miner_armor.png");
    }

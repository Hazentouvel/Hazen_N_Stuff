...
public class CoruscatedValorArmorRenderer extends GeoArmorRenderer<CoruscatedValorArmorItem> {
    public CoruscatedValorArmorRenderer(CoruscatedValorArmorModel coruscatedValorArmorModel) {
        super(new CoruscatedValorArmorModel());
        this.addRenderLayer(new CoruscatedValorArmorLayer(this));
    ...
    public RenderType getRenderType(CoruscatedValorArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {

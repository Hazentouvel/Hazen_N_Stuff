package net.hazen.hazennstuff.Item.Armor.PureTier.ElderGuardian;
...
public class ElderGuardianArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    ...
    public List<ItemAttributeModifiers.Entry> createExtraAttributes() {
        ...
        GoetyCompat.addAbyssPotency(attributes, group);
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new ElderGuardianArmorModel());
    }
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof ElderGuardianArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof ElderGuardianArmorItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof ElderGuardianArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof ElderGuardianArmorItem;
    }
}

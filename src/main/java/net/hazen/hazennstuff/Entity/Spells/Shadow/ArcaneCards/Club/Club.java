...
public class Club extends AbstractMagicProjectile implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public Club(EntityType<? extends Club> entityType, Level level) {
        super(entityType, level);
        this.setNoGravity(true);
    }

    public Club(Level levelIn, LivingEntity shooter) {
        this(HnSEntityRegistry.CLUB.get(), levelIn);

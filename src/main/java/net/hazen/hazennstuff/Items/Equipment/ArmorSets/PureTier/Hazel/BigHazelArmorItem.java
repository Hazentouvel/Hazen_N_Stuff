...
public class BigHazelArmorItem extends HnSImbuableArmorItem {
    public BigHazelArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new BigHazelArmorModel());
    }
}
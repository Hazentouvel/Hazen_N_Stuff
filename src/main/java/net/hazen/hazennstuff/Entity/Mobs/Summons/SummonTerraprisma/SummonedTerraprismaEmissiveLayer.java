...
public class SummonedTerraprismaEmissiveLayer extends GeoRenderLayer<SummonedTerraprismicEntity> {

    public SummonedTerraprismaEmissiveLayer(GeoEntityRenderer<SummonedTerraprismicEntity> renderer) {
        super(renderer);
    }
    ...
    public void render(
            PoseStack poseStack,
            SummonedTerraprismicEntity animatable,

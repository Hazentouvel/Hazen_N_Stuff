...
public class OFortunaItem extends HnSGeoMagicSwordItem implements UniqueItem {

    public OFortunaItem(SpellDataRegistryHolder[] spellDataRegistryHolders) {
        super(HnSExtendedWeaponTiers.O_FORTUNA,
                HnSExtendedWeaponTiers.O_FORTUNA.getAttackDamageBonus(),
                HnSExtendedWeaponTiers.O_FORTUNA.getSpeed(),
                spellDataRegistryHolders,
                Map.of(
                        AttributeRegistry.NATURE_SPELL_POWER.get(), new AttributeModifier(UUID.fromString("a552273e-6669-4cd2-80b3-a703b7616336"),
                        ...
                        AttributeRegistry.CAST_TIME_REDUCTION.get(), new AttributeModifier(UUID.fromString("c552273e-6669-4cd2-80b3-a703b7616336"),
                                "Nature Spell Power", 0.15f, AttributeModifier.Operation.MULTIPLY_TOTAL)
                ),
    ...
    public BlockEntityWithoutLevelRenderer getRenderer() {
        return new OFortunaRenderer(new OFortunaModel());
    }
}
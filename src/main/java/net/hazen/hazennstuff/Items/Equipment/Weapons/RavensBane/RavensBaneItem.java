...
public class RavensBaneItem extends HnSGeoMagicSwordItem implements UniqueItem {

    public RavensBaneItem(SpellDataRegistryHolder[] spellDataRegistryHolders) {
        super(HnSExtendedWeaponTiers.RAVENS_BANE,
                HnSExtendedWeaponTiers.RAVENS_BANE.getAttackDamageBonus(),
                HnSExtendedWeaponTiers.RAVENS_BANE.getSpeed(),
                ...
                Map.of(
                        AttributeRegistry.FIRE_SPELL_POWER.get(), new AttributeModifier(UUID.fromString("a552273e-6669-4cd2-80b3-a703b7616336"),
                                "Fire Spell Power", 0.2f, AttributeModifier.Operation.MULTIPLY_TOTAL),
                        ...
                        GSLAttributeRegistry.SPELL_CRIT_CHANCE.get(), new AttributeModifier(UUID.fromString("b552273e-6669-4cd2-80b3-a703b7616336"),
                                "Spell Crit Chance", 0.1f, AttributeModifier.Operation.MULTIPLY_TOTAL),

                        GSLAttributeRegistry.SPELL_CRIT_DAMAGE.get(), new AttributeModifier(UUID.fromString("c552273e-6669-4cd2-80b3-a703b7616336"),
                                "Spell Crit Damage", 0.1f, AttributeModifier.Operation.MULTIPLY_TOTAL)
                ),
    ...
    public BlockEntityWithoutLevelRenderer getRenderer() {
        return new RavensBaneRenderer(new RavensBaneModel());
    }
}
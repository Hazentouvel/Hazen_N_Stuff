...
public class NautilusKnightArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    public NautilusKnightArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new NautilusKnightArmorModel());
    }
}
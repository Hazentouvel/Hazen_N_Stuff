...
public class RavensBaneItem extends MagicSwordItem implements GeoItem {
    ...
    private final AnimationController<RavensBaneItem> animationController = new AnimationController<>(this, "controller", 0, this::predicate);

    // Make your animations in this predicate
    private PlayState predicate(AnimationState<RavensBaneItem> event)
    {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private RavensBaneRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
                if (this.renderer == null)
                    this.renderer = new RavensBaneRenderer();
    ...
    public void appendHoverText(@NotNull ItemStack stack,
        ...
        lines.add(Component.translatable("item.hazennstuff.ravens_bane.description")

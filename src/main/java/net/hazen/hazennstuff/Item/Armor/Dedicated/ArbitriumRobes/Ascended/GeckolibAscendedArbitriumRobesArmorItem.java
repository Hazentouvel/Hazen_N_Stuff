package net.hazen.hazennstuff.Item.Armor.Dedicated.ArbitriumRobes.Ascended;
...
public class GeckolibAscendedArbitriumRobesArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public GeckolibAscendedArbitriumRobesArmorItem(Type type, Properties settings) {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof GeckolibAscendedArbitriumRobesArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof GeckolibAscendedArbitriumRobesElytraItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof GeckolibAscendedArbitriumRobesArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof GeckolibAscendedArbitriumRobesArmorItem;
    }

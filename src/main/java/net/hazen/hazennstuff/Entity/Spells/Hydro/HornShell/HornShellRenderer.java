...
public class HornShellRenderer extends GeoEntityRenderer<HornShell> {
    public HornShellRenderer(EntityRendererProvider.Context context) {
        super(context, new HornShellModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, HornShell animatable, BakedGeoModel model,

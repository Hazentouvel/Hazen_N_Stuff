...
public class Spark extends AbstractMagicProjectile implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public Spark(EntityType<? extends Projectile> pEntityType, Level pLevel) {
    ...
    {
        this(HnSEntityRegistry.SPARK.get(), level);
        setOwner(shooter);
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        try {
            ...
            DamageSources.applyDamage(
                    ...
                    damage,
                    SpellRegistries.SPARK.get().getDamageSource(this, getOwner())
            );
        } catch (Exception e) {}

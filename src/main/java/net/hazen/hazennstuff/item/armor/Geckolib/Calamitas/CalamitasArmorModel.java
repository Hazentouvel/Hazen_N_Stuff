...
public class CalamitasArmorModel extends DefaultedEntityGeoModel<CalamitasArmorItem> {
    ...
    public ResourceLocation getModelResource(CalamitasArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "geo/armor/calamitas/calamitas.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CalamitasArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "textures/armor/calamitas/calamitas.png");
    }

    @Override
    public ResourceLocation getAnimationResource(CalamitasArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HazenNStuff.MOD_ID, "animations/armor/calamitas/calamitas.animation.json");
    }
}

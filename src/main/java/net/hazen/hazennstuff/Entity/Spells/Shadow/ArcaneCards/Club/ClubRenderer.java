...
public class ClubRenderer extends GeoEntityRenderer<Club> {
    public ClubRenderer(EntityRendererProvider.Context context) {
        super(context, new ClubModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, Club animatable, BakedGeoModel model,

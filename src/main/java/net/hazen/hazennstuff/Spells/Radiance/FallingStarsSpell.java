...
@AutoSpellConfig
public class FallingStarsSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath("hazennstuff", "shooting_stars");

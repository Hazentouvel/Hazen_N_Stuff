package net.hazen.hazennstuff.Item.Staves.Reference.WhiteLilyStaff;
...
public class WhiteLilyStaff extends StaffItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public WhiteLilyStaff() {
        super(
                new Item
                        .Properties()
                        .stacksTo(1)
    ...
    private final AnimationController<WhiteLilyStaff> animationController = new AnimationController<>(this, "controller", 0, this::predicate);

    // Make your animations in this predicate
    private PlayState predicate(AnimationState<WhiteLilyStaff> event)
    {

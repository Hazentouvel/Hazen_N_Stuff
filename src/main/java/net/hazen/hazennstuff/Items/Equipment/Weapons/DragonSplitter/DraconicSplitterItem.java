...
public class DraconicSplitterItem extends HnSGeoMagicSwordItem implements UniqueItem {

    public DraconicSplitterItem(SpellDataRegistryHolder[] spellDataRegistryHolders) {
        super(HnSExtendedWeaponTiers.DRACONIC_SPLITTER,
                HnSExtendedWeaponTiers.DRACONIC_SPLITTER.getAttackDamageBonus(),
                HnSExtendedWeaponTiers.DRACONIC_SPLITTER.getSpeed(),
                ...
                Map.of(
                        ...
                        AttributeRegistry.CAST_TIME_REDUCTION.get(), new AttributeModifier(UUID.fromString("c552273e-6669-4cd2-80b3-a703b7616336"),
                                "Cast Time Reduction", -0.15f, AttributeModifier.Operation.MULTIPLY_TOTAL),

                        AttributeRegistry.SPELL_RESIST.get(), new AttributeModifier(UUID.fromString("c552273e-6669-4cd2-80b3-a703b7616336"),
                                "Spell Resist", 0.25f, AttributeModifier.Operation.MULTIPLY_TOTAL)
                ),
    ...
    public BlockEntityWithoutLevelRenderer getRenderer() {
        return new DraconicSplitterRenderer(new DraconicSplitterModel());
    }
}
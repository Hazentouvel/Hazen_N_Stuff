package net.hazen.hazennstuff.entity.mobs.ReignOfTyros.Pyromus;
...
import net.hazen.hazennstuff.entity.mobs.ReignOfTyros.Aptos.AptosModel;
...
public class PyromusRenderer extends AbstractSpellCastingMobRenderer {
    public PyromusRenderer(EntityRendererProvider.Context context) {
        super(context, new PyromusModel());

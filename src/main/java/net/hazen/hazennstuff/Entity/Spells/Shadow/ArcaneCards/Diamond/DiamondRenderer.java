...
public class DiamondRenderer extends GeoEntityRenderer<Diamond> {
    public DiamondRenderer(EntityRendererProvider.Context context) {
        super(context, new DiamondModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, Diamond animatable, BakedGeoModel model,

...
public class ChlorophyteHelmetArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    ...
    public void appendHoverText(@NotNull ItemStack stack,
        ...
        lines.add(Component.translatable("item.hazennstuff.chlorophyte_helmet.description")
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new ChlorophyteHelmetArmorModel());
    }
    ...
    private void evaluateArmorEffects(Player player) {
        if (!player.hasEffect(HnSEffects.MAGE_SET_BONUS)) {
            player.addEffect(new MobEffectInstance(HnSEffects.ARCHER_SET_BONUS, 200, 0, false, false, false));
        }
    }

    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof ChlorophyteHelmetArmorItem &&

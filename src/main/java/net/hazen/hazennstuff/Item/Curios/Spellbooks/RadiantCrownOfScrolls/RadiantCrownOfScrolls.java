...
public class RadiantCrownOfScrolls extends SpellBook {
    public final HnSDispatcher dispatcher;
    public RadiantCrownOfScrolls() {
        super(10);
        this.withSpellbookAttributes(new AttributeContainer[]{
                new AttributeContainer(HnSAttributeRegistry.RADIANCE_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE),

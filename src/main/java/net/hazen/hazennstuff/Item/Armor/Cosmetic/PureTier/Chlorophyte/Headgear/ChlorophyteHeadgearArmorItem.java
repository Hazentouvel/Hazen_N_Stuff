package net.hazen.hazennstuff.Item.Armor.Cosmetic.PureTier.Chlorophyte.Headgear;
...
public class ChlorophyteHeadgearArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    public ChlorophyteHeadgearArmorItem(Type type, Properties settings) {
    ...
    public void appendHoverText(@NotNull ItemStack stack,
        ...
        lines.add(Component.translatable("item.hazennstuff.chlorophyte_headgear.description")
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new ChlorophyteHeadgearArmorModel());
    }
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof ChlorophyteHeadgearArmorItem &&

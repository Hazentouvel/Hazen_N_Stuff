package net.hazen.hazennstuff.Item.Armor.Dedicated.Iron431.Ascended;
...
public class AscendedIron431ArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public AscendedIron431ArmorItem(Type type, Properties settings) {
    ...
    public void appendHoverText(@NotNull ItemStack stack,
        ...
        lines.add(Component.translatable("item.hazennstuff.iron431.description")
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new AscendedIron431ArmorModel());
    }
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof AscendedIron431ArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof GeckolibArbitriumRobesElytraItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof AscendedIron431ArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof AscendedIron431ArmorItem;
    }
}
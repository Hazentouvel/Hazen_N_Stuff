...
public class GeckolibFireblossomBattlemageCrownedArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof GeckolibFireblossomBattlemageCrownedArmorItem &&

...
public class ElderGuardianArmorModel extends DefaultedEntityGeoModel<ElderGuardianArmorItem> {
    public ElderGuardianArmorModel() {
    ...
    @Override
    public ResourceLocation getAnimationResource(ElderGuardianArmorItem animatable) {

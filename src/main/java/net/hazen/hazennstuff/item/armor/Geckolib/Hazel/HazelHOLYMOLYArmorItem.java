...
import net.hazen.hazennstuff.item.armor.Geckolib.Blazeborne.GeckolibBlazeborneArmorModel;
...
public class HazelHOLYMOLYArmorItem extends ImbuableGeckolibHnSArmorItem {

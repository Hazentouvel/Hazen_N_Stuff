...
public class PyromusEntity extends AbstractSpellCastingMob implements Enemy {

    public PyromusEntity(EntityType<? extends AbstractSpellCastingMob> pEntityType, Level pLevel) {

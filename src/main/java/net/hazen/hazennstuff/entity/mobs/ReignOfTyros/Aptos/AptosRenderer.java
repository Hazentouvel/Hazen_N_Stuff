...
public class AptosRenderer extends AbstractSpellCastingMobRenderer {
    public AptosRenderer(EntityRendererProvider.Context context) {
        super(context, new AptosModel());

...
public class CryogenicRulerArmorItem extends ImbuableGeckolibHnSArmorItem {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof CryogenicRulerArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof CryogenicRulerArmorItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof CryogenicRulerArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof CryogenicRulerArmorItem;
    }
}
...
public class FrierenStaff extends StaffItem implements GeoItem {
    ...
    private final AnimationController<FrierenStaff> animationController = new AnimationController<>(this, "controller", 0, this::predicate);

    // Make your animations in this predicate
    private PlayState predicate(AnimationState<FrierenStaff> event)
    {

...
public class Diamond extends AbstractMagicProjectile implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public Diamond(EntityType<? extends Diamond> entityType, Level level) {
        super(entityType, level);
        this.setNoGravity(true);
    }

    public Diamond(Level levelIn, LivingEntity shooter) {
        this(HnSEntityRegistry.DIAMOND.get(), levelIn);

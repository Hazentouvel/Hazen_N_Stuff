package net.hazen.hazennstuff.Particle.SlashParticles.Spells.NatureSlash;
...
public class NatureSlash extends TextureSheetParticle {
    ...
    NatureSlash(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double xd, double yd, double zd, NatureSlashOptions options) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<NatureSlashOptions> {
        ...
        public Particle createParticle(@NotNull NatureSlashOptions options, @NotNull ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            NatureSlash shriekparticle = new NatureSlash(pLevel, pX, pY, pZ, this.sprite, pXSpeed, pYSpeed, pZSpeed, options);

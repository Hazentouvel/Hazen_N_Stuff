...
public class FleshChunkRenderer extends GeoEntityRenderer<FleshChunk> {
    public FleshChunkRenderer(EntityRendererProvider.Context context) {
        super(context, new FleshChunkModel());
        this.shadowRadius = 0f;
    }

    @Override
    public void preRender(PoseStack poseStack, FleshChunk animatable, BakedGeoModel model,

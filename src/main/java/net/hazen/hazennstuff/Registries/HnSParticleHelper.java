...
public class HnSParticleHelper {
    ...
    public static final ParticleOptions SOUL_PARTICLE = HnSParticleRegistry.SOUL_PARTICLE.get();
    ...
    public static final ParticleOptions ENDER_EXPLOSION_PARTICLE = HnSParticleRegistry.ENDER_EXPLOSION_PARTICLE.get();

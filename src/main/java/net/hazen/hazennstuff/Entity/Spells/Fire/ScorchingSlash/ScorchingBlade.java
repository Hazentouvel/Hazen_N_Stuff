...
public class ScorchingBlade extends AbstractMagicProjectile implements GeoEntity {
    ...
    public ScorchingBlade(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public ScorchingBlade(Level level, LivingEntity shooter)
    {
    ...
    private void applyCounterspellArea(Vec3 center, LivingEntity owner, float radius) {
        ...
        for (LivingEntity livingTarget : targets) {
            ...
            try {
                DamageSources.applyDamage(livingTarget, damage, HnSSpellRegistries.SCORCHING_SLASH.get().getDamageSource(this, owner));

...
public class HazelHOLYMOLYArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    public HazelHOLYMOLYArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new HazelHOLYMOLYArmorModel());
    }
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof HazelArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof HazelHOLYMOLYArmorItem &&

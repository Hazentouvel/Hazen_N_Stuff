...
public class HnSUpgradeOrbTypeRegistry {
    ...
    public static ResourceKey<UpgradeOrbType> LUMINESCENT_SPELL_POWER = ResourceKey.create(UpgradeOrbTypeRegistry.UPGRADE_ORB_REGISTRY_KEY, HazenNStuff.id("luminescent_power"));
    public static ResourceKey<UpgradeOrbType> DARK_SPELL_POWER = ResourceKey.create(UpgradeOrbTypeRegistry.UPGRADE_ORB_REGISTRY_KEY, HazenNStuff.id("dark_power"));

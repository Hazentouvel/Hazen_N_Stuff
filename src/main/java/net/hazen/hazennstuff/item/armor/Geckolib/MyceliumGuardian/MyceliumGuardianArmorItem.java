...
import net.hazen.hazennstuff.item.armor.Geckolib.AbberantPredator.AbberantPredatorArmorModel;
import net.hazen.hazennstuff.item.armor.Geckolib.ImbuableGeckolibHnSArmorItem;
import net.hazen.hazennstuff.item.armor.Geckolib.PermafrostPrince.PermafrostPrinceArmorModel;
...
public class MyceliumGuardianArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {

...
import net.hazen.hazennstuff.item.armor.Geckolib.ArbitriumRobes.GeckolibArbitriumRobesArmorModel;
...
public class GeckolibGabrielElytraItem extends ImbuableChestplateArmorItem implements IDisableJacket {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new GeckolibGabrielElytraArmorModel());
    }

package net.hazen.hazennstuff.Item.Armor.PureTier.FleshMass;
...
public class FleshMassArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof FleshMassArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof FleshMassArmorItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof FleshMassArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof FleshMassArmorItem;
    }
}
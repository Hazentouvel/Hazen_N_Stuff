package net.hazen.hazennstuff.Item.Armor.PureTier.EnderDragon;
...
public class GeckolibEnderDragonArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    ...
    public List<ItemAttributeModifiers.Entry> createExtraAttributes() {
        ...
        GoetyCompat.addVoidPotency(attributes, group);
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof GeckolibEnderDragonArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof GeckolibEnderDragonArmorItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof GeckolibEnderDragonArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof GeckolibEnderDragonArmorItem;
    }
}
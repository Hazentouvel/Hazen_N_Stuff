package net.hazen.hazennstuff.Registries.ItemRegistry;
...
import net.hazen.hazennstuff.Item.Staves.RodOfDiscord.RodOfDiscordItem;
import net.hazen.hazennstuff.Item.Staves.SoulcallingScepter.SoulcallingScepterItem;
import net.hazen.hazennstuff.Item.Staves.WhiteLilyStaff.WhiteLilyStaffItem;
import net.hazen.hazennstuff.Item.Staves.WisewoodCane.WisewoodCaneItem;
...
import net.hazen.hazennstuff.Item.Weapons.AncientWarriorsAxe.AncientWarriorsAxeItem;
...
import net.hazen.hazennstuff.Item.Weapons.BountifulHarvest.BountifulHarvestItem;
...
import net.hazen.hazennstuff.Item.Weapons.FireblossomRapier.FireblossomRapierItem;
...
import net.hazen.hazennstuff.Item.Weapons.HammerOfJustice.HammerOfJusticeItem;
import net.hazen.hazennstuff.Item.Weapons.Hammush.HammushItem;
import net.hazen.hazennstuff.Item.Weapons.IcePike.IcePikeItem;
import net.hazen.hazennstuff.Item.Weapons.IonicSplitter.Dormant.IonicSplitterItem;
import net.hazen.hazennstuff.Item.Weapons.IonicSplitter.T1.IonicSplitterT1Item;
import net.hazen.hazennstuff.Item.Weapons.IonicSplitter.T2.IonicSplitterT2Item;
import net.hazen.hazennstuff.Item.Weapons.IonicSplitter.T3.IonicSplitterT3Item;
import net.hazen.hazennstuff.Item.Weapons.LegionnaireWarlockAxe.LegionnaireWarlockAxeItem;
import net.hazen.hazennstuff.Item.Weapons.LightsBane.LightsBaneItem;
...
import net.hazen.hazennstuff.Item.Weapons.Terraprisma.TerraprismaItem;
...
import net.hazen.hazennstuff.Item.Weapons.VampireKnives.VampireKnivesItem;
...
public class HnSGeckoLibArmorItemRegistry {
    ...
    *** Misc
    ...
    //White Lily Staff
    public static final DeferredHolder<Item, Item> SOULCALLING_SCEPTER = ITEMS.register("soulcalling_scepter", SoulcallingScepterItem::new);

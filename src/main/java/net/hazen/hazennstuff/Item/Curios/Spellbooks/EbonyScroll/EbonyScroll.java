package net.hazen.hazennstuff.Item.Curios.Spellbooks.EbonyScroll;
...
public class EbonyScroll extends SpellBook {
    public final HnSDispatcher dispatcher;
    public EbonyScroll() {
        super(10);
        this.withSpellbookAttributes(new AttributeContainer[]{
                new AttributeContainer(HnSAttributeRegistry.SHADOW_SPELL_POWER, 0.1, AttributeModifier.Operation.ADD_MULTIPLIED_BASE),

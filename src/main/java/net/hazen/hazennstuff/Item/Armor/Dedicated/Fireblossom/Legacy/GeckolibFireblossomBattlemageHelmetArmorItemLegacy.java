...
public class GeckolibFireblossomBattlemageHelmetArmorItemLegacy extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new GeckolibFireblossomBattlemageHelmetArmorModelLegacy());
    }
    @Override
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof GeckolibFireblossomBattlemageHelmetArmorItemLegacy &&

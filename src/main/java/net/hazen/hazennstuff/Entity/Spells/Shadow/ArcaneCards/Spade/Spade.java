...
public class Spade extends AbstractMagicProjectile implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public Spade(EntityType<? extends Spade> entityType, Level level) {
        super(entityType, level);
        this.setNoGravity(true);
    }

    public Spade(Level levelIn, LivingEntity shooter) {
        this(HnSEntityRegistry.SPADE.get(), levelIn);

...
import net.hazen.hazennstuff.item.armor.Geckolib.CreakingSorcerer.GeckolibCreakingSorcererArmorModel;
...
public class ChlorophyteArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket {
    public ChlorophyteArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new ChlorophyteArmorModel());
    }
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof ChlorophyteArmorItem &&

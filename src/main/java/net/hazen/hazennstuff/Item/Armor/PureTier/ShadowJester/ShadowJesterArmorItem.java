...
public class ShadowJesterArmorItem extends ImbuableGeckolibHnSArmorItem implements IDisableJacket, IDisableHat {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new ShadowJesterArmorModel());
    }
    ...
    private boolean isWearingFullSet(Player player) {
        return player.getItemBySlot(Type.HELMET.getSlot()).getItem() instanceof ShadowJesterArmorItem &&
                player.getItemBySlot(Type.CHESTPLATE.getSlot()).getItem() instanceof ShadowJesterArmorItem &&
                player.getItemBySlot(Type.LEGGINGS.getSlot()).getItem() instanceof ShadowJesterArmorItem &&
                player.getItemBySlot(Type.BOOTS.getSlot()).getItem() instanceof ShadowJesterArmorItem;
    }
}
